...
import { FaCode, FaReact, FaPlane } from 'react-icons/fa';
/**
 * Local import
 */
// data
...
const Biographie = ({ language }) => (
	<div id="biographie">
		...
		<div className="div-img">
			<img
				src="https://i.imgur.com/kIniG8c.jpg"
				alt="Gabriel"
				className="img-biographie"
			/>
		</div>
		<div className="bio-img">
			<ul>
				<li>
					<span className="span-bio_img">
						{language === 'fr' ? 'Âge:' : 'Age:'}
					</span>{' '}
					{textData[language].age}
				</li>
				<li>
					<span className="span-bio_img">
						{language === 'fr' ? 'Ville:' : 'City:'}
					</span>{' '}
					{textData[language].city}
				</li>
				<li>
					<span className="span-bio_img">Tel:</span> {textData[language].tel}
				</li>
				<li>
					<span className="span-bio_img">Email:</span>{' '}
					{textData[language].email}
				</li>
			</ul>
		</div>
		<p className="bio-p">
